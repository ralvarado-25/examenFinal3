                ...
                meta: (
                    <>
                        <span>
                            ...
                            <br />
                            {cart.adults} {cart.adults && +cart.adults > 1 ? 'Adultos' : 'Adulto'}
                        </span>
                        <span>
    ...
    if (selectedHotel?.details?.room_scenic.length) {
        selectedHotel.details.room_scenic.forEach((type) => {
            viewTypeOptions.push({
                ...
                meta: (
                    <>
                        <span>Incremento al precio</span>
            ...
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className={formClasses['form__wide-row']}>
                    <ImageCheckbox
                        ...
                        validationMessage="Por favor seleccione una habitación."
                ...
                <div className={formClasses['form__wide-row']}>
                    <ImageCheckbox
                        ...
                        validators={[[validatorjs.isLength, { min: 1, max: undefined }]]}
                        validationMessage="Por favor seleccione un tipo de vista"
                        onChange={inputHandler}
