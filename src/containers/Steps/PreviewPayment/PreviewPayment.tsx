                    ...
                    <div className={styleClasses['preview-payment__form']}>
                        ...
                        <div className={formClasses['form__wide-row']}>
                            ...
                            <TextField
                                ...
                                validationMessage="Por favor ingrese el Número de su tarjeta"
                        ...
                        <div className={formClasses['form__wide-row']}>
                            <div className={formClasses['form__have-two']}>
                                <span className={formClasses['form__label']}>Fecha de vencimiento de la tarjeta</span>
                                <Select
                                    id="month"
                                    ...
                                    validationMessage="Por favor seleccione la fecha de vencimiento de la tarjeta"
                                />
                                <Select
                                    id="year"
                                    ...
                                    validators={[[validatorjs.isLength, { min: 1, max: undefined }]]}
                                    validationMessage="Seleccione un año de vencimiento válida"
                                />
                            </div>
                            <TextField
                                id="cardCvv"
                                ...
                                validationMessage="Por favor ingrese un CVV válido"
                                onChange={inputHandler}
                                ref={turnCardHandler}
                            />
                        </div>
